...
you can find the README at https://github.com/teamcapybara/capybara/blob/3.32_stable/README.md
...
bundle exec rake spec_chrome # run the test suite with Chrome - requires `chromedriver` to be installed
```
